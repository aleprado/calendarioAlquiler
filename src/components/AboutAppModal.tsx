...
const defaultContent = (
  <>
    <p>
      Gestiona tus alojamientos turísticos desde un panel pensado para anfitriones: sincronización con Airbnb, bloqueos manuales y
...
export const AboutAppModal = ({ isOpen, onClose, title, children, primaryLabel }: AboutAppModalProps) => {
  if (!isOpen) return null

  return (
    <div className="modal-backdrop" role="presentation">
      <div className="modal modal--info" role="dialog" aria-modal="true" aria-labelledby="about-modal-title">
        <h2 id="about-modal-title">{title ?? '¿Qué es Simple Alquiler?'}</h2>
